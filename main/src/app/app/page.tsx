...
import { WalletMultiButton } from '@solana/wallet-adapter-react-ui';
import { useRouter } from 'next/navigation'; // or 'next/router' for older Next.js versions
import { X, Menu, Clock, Coins, FolderOpen, Wallet, QrCode, User, HelpCircle, ChevronDown, ChevronRight, Bot, Pen, Bell, Search, Zap, Star, Settings } from "lucide-react";
import WatchList from "../components/app/watchlist";
import HomePage from "../components/app/home";
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-6">
                                ...
                                <div className="relative hidden md:block">
                                    ...
                                    <input
                                        ...
                                        className="bg-[#3a3a3a] border border-gray-600 rounded-lg pl-10 pr-4 py-2 text-white placeholder-gray-400 focus:outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500 w-64"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                <div className="flex items-center space-x-2 bg-[#3a3a3a] rounded-lg px-4 py-2 border border-gray-600">
                                    ...
                                    <span className="text-gray-400 text-sm">QP</span>
                                </div>

                                {/* Favorites */}
                                <button className="p-2 bg-[#3a3a3a] rounded-lg border border-gray-600 hover:bg-[#4a4a4a] transition-colors">
